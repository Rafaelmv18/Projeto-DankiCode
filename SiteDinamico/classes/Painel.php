<?php
  class Painel{
    ...
    public static function alert($tipo, $mensagem) {
      if ($tipo == 'sucesso') {
          echo '<div class="box-alert sucesso"><ion-icon name="checkmark-sharp"></ion-icon>'.$mensagem.'</div>';
      } else if ($tipo == 'erro') {
          echo '<div class="box-alert erro"><ion-icon name="close"></ion-icon>'.$mensagem.'</div>';
      }
    }
    ...
    public static function insert($arr){
      ...
      if($certo){
          $sql = MySql::conectar()->prepare($query_final);
    ...
    // Metodo especifico para selecionar apesns 1 registro
    ...
    public static function orderItem($tabela, $orderType, $idItem) {
      ...
      if ($itemBefore->rowCount() == 0) return;
